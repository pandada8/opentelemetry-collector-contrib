...
DISTRIBUTIONS="${1:-}"
MANIFEST="${REPO_DIR}/cmd/otelcontribcol-diagnostics/manifest.yaml"
OBI_DIR="${REPO_DIR}/internal/diagnostics/obi-src"
...
TARBALL_CACHE="${REPO_DIR}/cmd/otelcontribcol-diagnostics/_build/downloads/${TARBALL}"
...
mkdir -p "${REPO_DIR}/cmd/otelcontribcol-diagnostics/_build/downloads"
